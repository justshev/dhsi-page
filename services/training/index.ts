...
export async function getUpcomingLiveSessions(
  ...
  const { data } = await axiosInstance.get<APIResponse<{ sessions: LiveSession[] }>>(
    "/api/trainings/live/upcoming",
    { params: { limit } }
  );
  return data;
}
...
export async function getMyTrainings(): Promise<APIResponse<{ trainings: UserTraining[] }>> {
  const { data } = await axiosInstance.get<APIResponse<{ trainings: UserTraining[] }>>(
...
export async function startTraining(
  ...
  const { data } = await axiosInstance.post<APIResponse<{ user_training: UserTraining }>>(
...
export async function getTrainingProgress(
  trainingId: string
): Promise<APIResponse<{ progress: UserTraining & { modules: TrainingModule[] } }>> {
  const { data } = await axiosInstance.get<APIResponse<{ progress: UserTraining & { modules: TrainingModule[] } }>>(
...
export async function updateModuleProgress(
  ...
  const { data } = await axiosInstance.patch<APIResponse<{ progress: ModuleProgress }>>(
    `/api/trainings/modules/${moduleId}/progress`,
    payload
  );
  return data;
}
...
export async function getLiveSessionZoomLink(
  sessionId: string
): Promise<APIResponse<{ zoom_link: string; title: string; scheduled_at: string }>> {
  const { data } = await axiosInstance.get<APIResponse<{ zoom_link: string; title: string; scheduled_at: string }>>(
...
export async function createTraining(
  ...
  const { data } = await axiosInstance.post<APIResponse<{ training: Training }>>(
    "/api/trainings/admin",
    payload
  );
  return data;
...
export async function updateTraining(
  ...
  const { data } = await axiosInstance.patch<APIResponse<{ training: Training }>>(
    `/api/trainings/admin/${id}`,
    payload
  );
  return data;
...
export async function createModule(
  ...
  const { data } = await axiosInstance.post<APIResponse<{ module: TrainingModule }>>(
    `/api/trainings/admin/${trainingId}/modules`,
    payload
  );
  return data;
}
...
export async function updateModule(
  ...
  const { data } = await axiosInstance.patch<APIResponse<{ module: TrainingModule }>>(
...
export async function createLiveSession(
  ...
  const { data } = await axiosInstance.post<APIResponse<{ session: LiveSession }>>(
    `/api/trainings/admin/${trainingId}/live-sessions`,
    payload
  );
  return data;
}
...
export async function updateLiveSession(
  ...
  const { data } = await axiosInstance.patch<APIResponse<{ session: LiveSession }>>(
...
export async function deleteLiveSession(sessionId: string): Promise<APIResponse<null>> {
  const { data } = await axiosInstance.delete<APIResponse<null>>(
    `/api/trainings/admin/live-sessions/${sessionId}`
  );
  return data;
